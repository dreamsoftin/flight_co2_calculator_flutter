...
class CO2Calculator {
  ...
  static double _interpolate(
      {required double a, required double b, required double value}) {
    return b * value + a * (1 - value);
  }

  static _FlightParameters flightParameters({required double distanceKm}) {
    ...
    return _FlightParameters(
        ...
        firstCW: _interpolate(
            a: s.firstCW!, b: l.firstCW!, value: normalizedDistance),
